...
func main() {
	...
	// and finally, a series of concrete transport adapters. Note the transport
	// adapters aren't bound to ports or listening yet; we'll do that next.
	var (
	...
	{
		// The Thrift socket mounts the Go kit Thrift server we created.
